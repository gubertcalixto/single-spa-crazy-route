	...
	return {
		execute: function () {
			...
			window.history.pushState = function (state) {
			  var date = new Date();
			  console.log("pushState Start: ".concat(date.getSeconds(), " ").concat(date.getMilliseconds()));
			  var result = originalPushState.apply(this, arguments);
			  var date2 = new Date();
			  console.log("pushState Medium: ".concat(date2.getSeconds(), " ").concat(date2.getMilliseconds()));
			  urlReroute(createPopStateEvent(state));
			  var date3 = new Date();
			  console.log("pushState End: ".concat(date3.getSeconds(), " ").concat(date3.getMilliseconds()));
			  return result;
			};
			...
			window.history.replaceState = function (state) {
			  var date = new Date();
			  console.log("replaceState Start: ".concat(date.getSeconds(), " ").concat(date.getMilliseconds()));
			  var result = originalReplaceState.apply(this, arguments);
			  var date2 = new Date();
			  console.log("replaceState Medium: ".concat(date2.getSeconds(), " ").concat(date2.getMilliseconds()));
			  urlReroute(createPopStateEvent(state));
			  var date3 = new Date();
			  console.log("replaceState End: ".concat(date3.getSeconds(), " ").concat(date3.getMilliseconds()));
			  return result;
			};
